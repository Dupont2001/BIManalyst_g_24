# Introduction: 
The chosen OpenBIM role is "Analyst Level 3", as a standalone Python programme using IFC-Openshell. The tutorial video explains how to correctly calculate the line load for beams in a building.
